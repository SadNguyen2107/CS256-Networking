 ...
 * @param ppStudent If nullptr -> no need to assign ELSE the memory address of the pointer student-Object
 * @return return -1 if that Student Have No Group Belong To else > 0
 */
